...
export default function InvoiceListPage() {
  ...
  const TABS = [
    ...
    { value: 'paid', label: 'Pago', color: 'success', count: getLengthByStatus('paid') },
    { value: 'unpaid', label: 'Pendentes', color: 'warning', count: getLengthByStatus('unpaid') },
    { value: 'overdue', label: 'Atrasados', color: 'error', count: getLengthByStatus('overdue') },
    { value: 'draft', label: 'Orçamentos', color: 'default', count: getLengthByStatus('draft') },
  ] as const;
  ...
  return (
    <>
      <Helmet>
        <title> Invoice: List | SESPAT</title>
      </Helmet>
      ...
      <ConfirmDialog
        ...
        content={
          <>
            Voce tem certeza que deseja excluir <strong> {selected.length} </strong> itens?
          </>
        }
        action={
          <Button
