...
export default function InvoiceListPage() {
  ...
  const TABS = [
    ...
    { value: 'paid', label: 'Aprovados', color: 'success', count: getLengthByStatus('paid') },
    { value: 'unpaid', label: 'Pendentes', color: 'info', count: getLengthByStatus('unpaid') },
    { value: 'overdue', label: 'Atrasados', color: 'warning', count: getLengthByStatus('overdue') },
    { value: 'draft', label: 'Reprovados', color: 'error', count: getLengthByStatus('draft') },
  ] as const;
